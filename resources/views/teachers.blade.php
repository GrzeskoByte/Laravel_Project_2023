    ...
    <ul class="flex-grow bg-slate-200 divide-y divide-gray-200 mx-10 my-5">
        ...
        <li class="pb-3 sm:pb-4 w-full px-10 py-5">
            <div class="flex items-center space-x-4 rtl:space-x-reverse">
                ...
                <button type="button"  class="text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 focus:outline-none">
                            View
                        </button>
                    </a>
